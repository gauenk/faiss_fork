...
def compute_nlm_weights(burst,inds,modes,ps):
    ...
    # -- run numba --
    compute_nlm_weights_numba(weights,burst_nba,inds_nba,modes_nba,ps)
...
@njit
def compute_nlm_weights_numba(weights,burst,inds,modes,ps):
